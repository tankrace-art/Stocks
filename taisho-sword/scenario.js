...
export const CHAPTERS = [
  {
    ...
    theme: 'wisteria', scale: { hp: 1.15, dmg: 1.1 },
    waves: [
      ...
      { boss: { id: 'tede', name: '손 도깨비 — 우로코다키의 제자들을 먹은 자', body: 0x6a8a4a, loin: 0x3a2a2a, eye: 0xffe040, hp: 546, scale: 2.6, dmg: 14, skills: ['slam', 'charge', 'summon'] }, title: '손 도깨비', sub: '47년 동안 산에 갇혀 있던 도깨비' },
    ],
  ...
  },
  {
    ...
    theme: 'town', scale: { hp: 1.4, dmg: 1.3 },
    waves: [
      { melee: 3, ranged: 1, title: '거리의 도깨비', sub: '골목마다 눈이 빛난다' },
      { melee: 3, ranged: 3, title: '무잔의 부하들', sub: '피를 받은 자들' },
      { boss: { id: 'swamp', name: '늪 도깨비 — 열여섯 살 소녀를 노리는 자', body: 0x2a3a4a, loin: 0x1a2a1a, eye: 0xff60a0, hp: 728, scale: 2.0, dmg: 16, skills: ['blink', 'field', 'charge'] }, title: '늪 도깨비', sub: '늪 속에서 셋이 동시에 솟아오른다' },
    ],
  ...
  },
  {
    ...
    theme: 'spider', scale: { hp: 1.7, dmg: 1.45 },
    ...
    waves: [
      ...
      { boss: { id: 'rui', name: `루이 — ${L(5)}`, body: 0xf0f0f4, loin: 0x3a2a4a, eye: 0xff3030, hp: 1014, scale: 2.0, dmg: 18, skills: ['fan', 'field', 'blink'] }, title: '하현 오 · 루이', sub: '"가족의 인연"을 강요하는 소년' },
    ],
  ...
  },
  {
    ...
    theme: 'train', scale: { hp: 2.0, dmg: 1.6 },
    joinAllyStart: ['rengoku'],
    waves: [
      { melee: 4, ranged: 2, title: '꿈에 갇힌 승객들', sub: '열차가 살아 움직인다' },
      { boss: { id: 'enmu', name: `엔무 — ${L(1)}`, body: 0x8a6a9a, loin: 0x2a1a3a, eye: 0x60c0ff, hp: 1170, scale: 2.2, dmg: 18, skills: ['field', 'summon', 'fan'] }, title: '하현 일 · 엔무', sub: '열차 전체가 그의 몸이다' },
      { boss: { id: 'akaza1', name: `아카자 — ${U(3)}`, body: 0xffd0b0, loin: 0x2a4a8a, eye: 0xffd040, hp: 1820, scale: 2.4, dmg: 22, skills: ['blink', 'beam', 'charge'] }, title: '상현 삼 · 아카자', sub: '"강한 자여, 도깨비가 되어라"' },
    ],
  ...
  },
  {
    ...
    theme: 'district', scale: { hp: 2.3, dmg: 1.75 },
    joinAllyStart: ['tengen'],
    waves: [
      { melee: 4, ranged: 3, title: '유곽의 밤', sub: '띠 속에 갇힌 사람들' },
      { boss: { id: 'daki', name: `다키 — ${U(6)}`, body: 0xf8e0e8, loin: 0xd04080, eye: 0xff5090, hp: 1170, scale: 2.0, dmg: 18, skills: ['fan', 'thread', 'blink'] }, title: '상현 육 · 다키', sub: '오비가 유곽 전체를 휘감는다' },
      { boss: { id: 'gyutaro', name: `규타로 — ${U(6)}`, body: 0x5a7a5a, loin: 0x2a1a1a, eye: 0xa0ff40, hp: 1690, scale: 2.3, dmg: 22, skills: ['fan', 'field', 'charge', 'summon'] }, title: '상현 육 · 규타로', sub: '피의 낫이 독을 뿌린다' },
    ],
  ...
  },
  {
    ...
    theme: 'village', scale: { hp: 2.6, dmg: 1.9 },
    joinAllyStart: ['mitsuri'],
    waves: [
      { melee: 4, ranged: 4, title: '마을의 습격', sub: '항아리에서 물고기 도깨비가 쏟아진다' },
      { boss: { id: 'gyokko', name: `교쿠코 — ${U(5)}`, body: 0x8ab0d0, loin: 0x2a3a6a, eye: 0xff8040, hp: 1560, scale: 2.2, dmg: 22, skills: ['fan', 'summon', 'field'] }, title: '상현 오 · 교쿠코', sub: '항아리 속에서 예술을 논한다' },
      { boss: { id: 'hantengu', name: `한텐구 — ${U(4)}`, body: 0x3a2a4a, loin: 0x6a2a2a, eye: 0xffd040, hp: 1950, scale: 2.4, dmg: 24, skills: ['summon', 'beam', 'blink', 'fan'] }, title: '상현 사 · 한텐구', sub: '베어도 베어도 분열한다 — 본체를 찾아라' },
    ],
  ...
  },
  {
    ...
    theme: 'labyrinth', scale: { hp: 3.0, dmg: 2.1 },
    joinAllyStart: ['giyu'],
    waves: [
      { melee: 5, ranged: 4, title: '뒤집힌 복도', sub: '무한히 이어지는 성' },
      { boss: { id: 'doma', name: `도우마 — ${U(2)}`, body: 0xf8f0ff, loin: 0xd0a040, eye: 0xffa0c0, hp: 1950, scale: 2.3, dmg: 24, skills: ['field', 'fan', 'blink', 'firering'] }, title: '상현 이 · 도우마', sub: '얼음 연꽃이 피어난다 — 시노부의 독이 퍼지고 있다' },
      { boss: { id: 'akaza2', name: `아카자 — ${U(3)}`, body: 0xffd0b0, loin: 0x2a4a8a, eye: 0xffd040, hp: 2340, scale: 2.4, dmg: 26, skills: ['blink', 'beam', 'charge', 'firering'] }, title: '상현 삼 · 아카자', sub: '투명한 세계 — 투기를 버려라' },
      { boss: { id: 'kokushibo', name: `코쿠시보 — ${U(1)}`, body: 0x3a2a3a, loin: 0x6a2a2a, eye: 0xff4040, hp: 3120, scale: 2.6, dmg: 28, skills: ['beam', 'fan', 'blink', 'summon'] }, title: '상현 일 · 코쿠시보', sub: '달의 호흡 — 여섯 개의 눈' },
    ],
  ...
  },
  {
    ...
    theme: 'ruins', scale: { hp: 3.4, dmg: 2.3 },
    joinAllyStart: ['giyu', 'sanemi'],
    nightLength: 210, dawnClear: true,
    waves: [
      { melee: 4, ranged: 3, title: '무잔의 부하들', sub: '새벽까지 4분' },
      { boss: { id: 'muzan', name: '키부츠지 무잔 — 도깨비의 시조', body: 0xf0e0f0, loin: 0x1a0a2a, eye: 0xff2040, hp: 7800, scale: 2.8, dmg: 30, skills: ['thread', 'beam', 'blink', 'summon', 'firering', 'charge'], undying: true }, title: '키부츠지 무잔', sub: '베어도 재생한다 — 햇빛이 뜰 때까지 버텨라' },
    ],
