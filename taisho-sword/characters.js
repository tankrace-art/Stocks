...
export const CHARACTERS = [
  {
    ...
    moves: { l3: '물의 호흡 제1형 · 물면 베기', rush: '물의 호흡 제2형 · 물수레', heavy: '물의 호흡 제4형 · 치는 파도', special: '히노카미 카구라 · 원무' },
    attackTheme: 'wave',
  ...
  },
  {
    ...
    moves: { l3: '번개의 호흡 · 육연', rush: '번개의 호흡 제1형 · 벽력일섬', heavy: '번개의 호흡 · 팔연', special: '벽력일섬 · 신속 (神速)' },
  ...
  },
  {
    ...
    moves: { l3: '짐승의 호흡 삼의 엄니 · 물어뜯기', rush: '짐승의 호흡 일의 엄니 · 꿰뚫기', heavy: '짐승의 호흡 오의 엄니 · 미친 베기', special: '짐승의 호흡 칠의 형 · 공간 식각' },
    attackTheme: 'quake',
