...
export const CHARACTERS = [
  {
    ...
    colors: { kimono: 0x1a3a3a, hakama: 0x1b1f33, haori: 0x1e4a3a, scarf: 0xf1e9d6, hair: 0x5a1e1e, obi: 0xf0e6d2, glow: 0x40a0ff, eye: 0x8a2a2a, pattern: 0x0e0e12 },
    look: { pattern: 'check', earring: true, scar: true, bangs: [0.22, 0.3, 0.2, 0.32, 0.22], browTilt: 0.2 },
    stats: { hp: 125, speed: 6.3, dmg: 1.0, gauge: 1.05, dashCooldown: 0.7 },
    moves: { l3: '물의 호흡 제1형 · 물면 베기', rush: '물의 호흡 제2형 · 물수레', heavy: '물의 호흡 제4형 · 치는 파도', flurry: '물의 호흡 제3형 · 유류무', sweep: '물의 호흡 제5형 · 간천의 자우', wave: '물의 호흡 제10형 · 생생유전', special: '히노카미 카구라 · 원무' },
    attackTheme: 'wave',
  ...
  },
  {
    ...
    colors: { kimono: 0xe8b23a, hakama: 0x1a1a1a, haori: 0xf0c040, scarf: 0xffffff, hair: 0xf2c84a, obi: 0x222222, glow: 0xfff070, eye: 0xc08020, pattern: 0xfff4d0 },
    look: { pattern: 'uroko', bangs: [0.3, 0.22, 0.34, 0.22, 0.3], browTilt: 0.5, longSide: true },
    stats: { hp: 100, speed: 7.4, dmg: 0.92, gauge: 1.1, dashCooldown: 0.4 },
    moves: { l3: '번개의 호흡 · 육연', rush: '번개의 호흡 제1형 · 벽력일섬', heavy: '번개의 호흡 · 팔연', flurry: '벽력일섬 · 연속', sweep: '번개의 호흡 제7형 · 화뢰신', wave: '번개의 호흡 · 원뢰', special: '벽력일섬 · 신속 (神速)' },
  ...
  },
  {
    ...
    colors: { kimono: 0x3a4a5a, hakama: 0x2a2a3a, haori: 0x3a4a5a, scarf: 0x8a7a5a, hair: 0x1a1a2a, obi: 0x6a5a3a, glow: 0xff9040, eye: 0x30c0a0, pattern: 0x8a7a5a },
    look: { boarMask: true, bladeScale: 1.35, twinBlades: true, bangs: [0.3, 0.3, 0.3, 0.3, 0.3] },
    stats: { hp: 150, speed: 5.8, dmg: 1.3, gauge: 0.9, dashCooldown: 0.8 },
    moves: { l3: '짐승의 호흡 삼의 엄니 · 물어뜯기', rush: '짐승의 호흡 일의 엄니 · 꿰뚫기', heavy: '짐승의 호흡 오의 엄니 · 미친 베기', flurry: '짐승의 호흡 이의 엄니 · 가르기', sweep: '짐승의 호흡 사의 엄니 · 잘게 찢기', wave: '짐승의 호흡 육의 엄니 · 난잡 물어뜯기', special: '짐승의 호흡 칠의 형 · 공간 식각' },
    attackTheme: 'quake',
